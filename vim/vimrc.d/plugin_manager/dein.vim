...
if dein#load_state(s:dein_root_dir)
  call dein#begin(s:dein_root_dir, '~/.vim/vimrc.d/plugin_manager/dein.vim')

  " Load a plugins list
  call dein#load_toml('~/.vim/vimrc.d/plugin_manager/dein.toml')
...
" Load and update nvim remote plugins
" if has('nvim')
